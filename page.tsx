  ...
  return (
    <div className="min-h-screen bg-[#1A1210] text-[#F4C9AC] p-6 md:p-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 auto-rows-min">
        ...
        {/* ── To-Do (was row2 col3, now row2 col1) ─────────────────── */}
        <section className="bg-[#2A1F1B] rounded-xl p-5 border border-[#AE645533]">
          <div className="flex justify-between items-baseline mb-4">
        ...
        {/* ── Watched + Books (center column, spans 2 rows) ────────── */}
        <section className="bg-[#2A1F1B] rounded-xl p-5 border border-[#AE645533] lg:row-span-2">
          {/* Watched This Year */}
          <div className="flex justify-between items-baseline mb-4">
          ...
          {/* Books */}
          <div className="mt-5 pt-4 border-t border-[#AE645533]">
        ...
        {/* ── Now Showing (was row2 col1, now row2 col3) ──────────── */}
        <section className="bg-[#2A1F1B] rounded-xl p-5 border border-[#AE645533]">
          <div className="flex justify-between items-baseline mb-4">
